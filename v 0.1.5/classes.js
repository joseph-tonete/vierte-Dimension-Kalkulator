...
export class CuboGraph  {
    constructor (size, position, color, graphValue, graphCoordinates, graphState){
        this.size = size
        this.position = position
        this.color = color
        this.graphValue = graphValue
    ...
    construct (){
        ...
        this.obj = new THREE.Mesh( geometry, material );
        this.obj.position.set(this.position[0],this.position[1],this.position[2])
        this.obj.name = this.graphValue + "@" + this.graphCoordinates[0] + "@" + this.graphCoordinates[1] + "@" + this.graphCoordinates[2] + "@" + this.color.r + "@" + this.color.g + "@" + this.color.b
    }
}